...
Runbooks are executable safety checklists. Replace angle-bracket placeholders,
record the operator/ticket/time, and prefer a second reviewer for shared or
...
- [Windows-host/WSL2 physical-device private HTTPS — proposed and blocked](./physical-device-windows-wsl2-private-https.md)
- [Physical-device private HTTPS — legacy macOS-only](./physical-device-private-https.md)
