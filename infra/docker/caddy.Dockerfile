...
LABEL io.cronometer.runtime.component="caddy" \
      ...
      io.cronometer.upstream.vulnerability-patches="golang.org/x/crypto=v0.55.0,golang.org/x/net=v0.57.0,golang.org/x/text=v0.41.0,google.golang.org/grpc=v1.82.1"
